...
chars_a = chars_a[((chars_a['exchcd'] == 1) | (chars_a['exchcd'] == 2) | (chars_a['exchcd'] == 3))].reset_index(drop=True)

# save data
with open('chars_a_raw_left_merge.feather', 'wb') as f:
...
chars_q = chars_q[((chars_q['exchcd'] == 1) | (chars_q['exchcd'] == 2) | (chars_q['exchcd'] == 3))].reset_index(drop=True)

# save data
with open('chars_q_raw_left_merge.feather', 'wb') as f:
