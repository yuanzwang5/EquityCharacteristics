...
#    All Stocks    #
####################
with open('chars_q_raw_left_merge.feather', 'rb') as f:
...
with open('chars_a_raw_left_merge.feather', 'rb') as f:
...
# df_rank = pd.read_feather("chars_rank_no_impute_left_merge.feather")
